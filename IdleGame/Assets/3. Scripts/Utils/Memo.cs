...
public class Memo
{
    ...
    TODO : Atlas로 사용하는 이미지들 확실하게 => 일단 maxsize 올려놓긴했음 확인해봐야함
    TODO : 모든 광고 제거 안되는 이유 => 앱에서 넣었음 테스트 해보기
    TODO : 공격속도 적용되는지 확인(스탯에서도) => 일단 수정은 해놨는데 세부 수치 확인해보기
    TODO : 버프 레벨, fastmode image
    TODO : 로그인하고 ID 메인씬에 적용하기
    
    TODO : 결과창 성공만 테스트하면 됌 => 성공했을때 보상이 안나옴
    TODO ; 로그아웃 이미지, 애플 로그인 일단 삭제 => 로그아웃은 게스트일때는 나오면 안됌
    TODO : 영웅, 유물에서 소환하기 누르면 안되는거
    TODO : 각종 반지 효과 만들고, 이미지도 만들어야됌. 유물팝업 양쪽으로 너무 넓어져있음
    TODO : 상점 팝업 처음에 영웅소환, 유물소환 text, image잘 안맞음
    TODO : 하단 스크롤도 에러있음
    TODO : 각인아이템 획득하는거 넣어서 테스트 해보기
